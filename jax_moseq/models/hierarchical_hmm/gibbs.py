...
def resample_higher_stateseqs(seed, **kwargs): # add params
    ...
    # Get log likelihood of high stateseq, given ??betas?? and z lower
    
    # Sample hmm stateseq, given those logliks and pi higher
...
def resample_lower_stateseqs(seed, **kwargs): # add params
    ...
    # Get log likelihood of low stateseq, given gaussian distributions for each state
    # ll = map over N (loglik(x) given mu, Q)

    # Sample hmm stateseq, given those logliks and pi lower
    # _, z = mixed map (sample_hmm_stateseq, given pi and ll)
...
def resample_gaussian_params(seed, mask, x, num_states_lower, num_states_higher, **kwargs): # add hypers
    ...
    # Somehow come up with a scale and df parameters for the NIW distribution
